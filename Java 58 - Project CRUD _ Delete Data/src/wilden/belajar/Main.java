...
public class Main {
    ...
    private static void deleteData() throws IOException{
        ...
        while (data != null) {            
            ...
            if (isDelete) {
                ...
                // kita pindahkan darai dari original ke sementara
    ...
    private static void tambahData() throws IOException{
        ...
        System.out.print("Masukan tahun terbut, format=(yyyy): ");
        tahun = ambilTahun();
        ...
        if (!isExist) {
            ...
            System.out.println("Tahun Terbit    : " + primaryKey);
            System.out.println("Penulis         : " + primaryKey);
            System.out.println("Judul           : " + primaryKey);
            System.out.println("Penerbit        : " + primaryKey);
            ...
            System.out.println("Buku yang anda akan masukan sudah ada di database");
